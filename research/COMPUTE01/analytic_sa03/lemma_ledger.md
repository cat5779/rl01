...
| Item | Status | Role |
|---|---|---|
| V14 compensated local kernel | inherited, pending independent review | exact finite/infinite interface |
| `A_R''(0)=Gamma(c)+o(1)` | inherited, pending independent review | volume bridge |
| R=1 closed-form match | checked in current run | implementation anchor |
| Exact physical-word enumeration through R=9 | checked in current run | finite sign and budget data |
