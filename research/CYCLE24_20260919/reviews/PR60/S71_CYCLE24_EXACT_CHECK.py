#!/usr/bin/env python3
"""Exact checks extracted from the visible S71/QWE08 Cycle24 response.

These checks concern the affine mixture of actual endpoint sine laws, not the
actual intermediate kernel-shift DPP.
"""
...
def main() -> None:
    ...
    # Positive Taylor remainders prove log(20)<3 and log(20000)<10.
