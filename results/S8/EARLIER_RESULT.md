...
[OBSTRUCTIONS.md](EARLIER_OBSTRUCTIONS.md).
...
[DEPENDENCY_DELTA.md](EARLIER_DEPENDENCY_DELTA.md). All logarithms are natural.
...
Compare the seven JSON files with [certificates/](https://github.com/cat5779/rl01/blob/7f081d311ced85cbf850605646808425f6b70129/sine-entropy/round4/optional/S8/certificates). The checker
