...
The [original proof](source/proof.md) is preserved byte-for-byte, together with
its original package, manifests, finite evidence, attempts, and claimed timing.
The [full independent audit](INDEPENDENT_AUDIT.md) covers both mathematical
results and reproduction. A [second fresh audit](SIGN_SECOND_AUDIT.md) checks
